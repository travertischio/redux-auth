...
var _marked =
/*#__PURE__*/
_regenerator["default"].mark(watchConfirmCodeAction),
    _marked2 =
/*#__PURE__*/
_regenerator["default"].mark(confirmCodeSaga);

function watchConfirmCodeAction() {
  var confirmCodeActionWatcher;
  return _regenerator["default"].wrap(function watchConfirmCodeAction$(_context) {
    while (1) {
...
function confirmCodeSaga(action) {
  ...
  return _regenerator["default"].wrap(function confirmCodeSaga$(_context2) {
    while (1) {
...
var _default = [watchConfirmCodeAction];
