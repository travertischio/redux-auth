...
var _TokenIsSet = require('../../hocs/AuthWrappers/TokenIsSet');

var _TokenIsSet2 = _interopRequireDefault(_TokenIsSet);
...
function createSignInConfirmCodeContainer(PageComponent) {
  ...
  var mapStateToProps = (0, _reselect.createStructuredSelector)({
    SignInConfirmCodePage: _selectors2.default
  });

  var mapDispatchToProps = {
    onSubmitForm: _actions.confirmCodeAction,
    onUnMount: _actions.destroyPageAction
  };

  var SignInContainer = (_dec = (0, _recompose.compose)(_config2.default.signInAuthWrapper), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), (0, _TokenIsSet2.default)(_class = _dec(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
