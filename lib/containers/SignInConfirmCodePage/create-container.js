...
function createSignInConfirmCodeContainer(PageComponent) {
  ...
  var SignInContainer = (_dec = (0, _recompose.compose)(_config2.default.signInAuthWrapper), _dec2 = (0, _reactRedux.connect)(null, mapDispatchToProps), (0, _TokeDataExists2.default)(_class = _dec(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
