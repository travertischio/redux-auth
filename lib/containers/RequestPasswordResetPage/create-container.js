...
function createRequestPasswordResetContainer(FormComponent) {
  ...
  var RequestPasswordResetContainer = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), (0, _UserIsNotAuthenticated2.default)(_class = (0, _reactIntl.injectIntl)(_class = _dec(_class = (_temp = _class2 = function (_PureComponent) {
    _inherits(RequestPasswordResetContainer, _PureComponent);

    function RequestPasswordResetContainer() {
      _classCallCheck(this, RequestPasswordResetContainer);

      return _possibleConstructorReturn(this, (RequestPasswordResetContainer.__proto__ || Object.getPrototypeOf(RequestPasswordResetContainer)).apply(this, arguments));
    }

    _createClass(RequestPasswordResetContainer, [{
