...
function createRequestPasswordResetContainer(PageComponent) {
  ...
  var RequestPasswordResetContainer = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = (0, _reactIntl.injectIntl)(_class = (_temp = _class2 = function (_PureComponent) {
