...
var AuthWrapper = _config2.default.signUpAuthWrapper || _UserIsNotAuthenticated2.default;
...
function createSignUpContainer(PageComponent) {
  ...
  var SignUpContainer = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), AuthWrapper(_class = _dec(_class = (0, _reactIntl.injectIntl)(_class = (_temp = _class2 = function (_PureComponent) {
