    ...
    return {
      onSubmitForm: function onSubmitForm(values) {
        return new Promise(function (resolve, reject) {
          ...
          throw new _immutable.SubmissionError(error.response.data);
        });
      }
    };
  };

  var SignUpContainer = (_dec = (0, _recompose.compose)(_config2.default.signUpAuthWrapper), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
