...
var _UserIsNotAuthenticatedWithCustomRedirect = require('../../hocs/AuthWrappers/UserIsNotAuthenticatedWithCustomRedirect');
...
function createSignUpContainer(PageComponent) {
  ...
  var SignUpContainer = (_dec = (0, _UserIsNotAuthenticatedWithCustomRedirect2.default)(_config2.default.redirectPathAfterSignUp), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
