...
function createSignUpContainer(PageComponent) {
  ...
  var SignUpContainer = (_dec = (0, _recompose.compose)(_config2.default.signUpAuthWrapper), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = _dec2(_class = (0, _reactIntl.injectIntl)(_class = (_temp = _class2 = function (_PureComponent) {
