    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.next = 5;
          return (0, _reduxSaga.takeEvery)(_constants.SIGN_UP_SUCCESS_ACTION, _sagas.setTokenIfExistsSaga);
  ...
  return regeneratorRuntime.wrap(function signUpSaga$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 6:
          _context2.next = 8;
          return (0, _effects.put)((0, _reactRouterRedux.push)(_config2.default.redirectPathAfterSignUp));
