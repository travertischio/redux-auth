...
_regenerator["default"].mark(defaultSaga),
    _marked2 =
/*#__PURE__*/
_regenerator["default"].mark(signUpSaga);
  ...
  return _regenerator["default"].wrap(function defaultSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _effects.takeLatest)(_constants.SIGN_UP_ACTION, signUpSaga);
...
function signUpSaga(action) {
  ...
  return _regenerator["default"].wrap(function signUpSaga$(_context2) {
    while (1) {
