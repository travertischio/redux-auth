...
exports.selectPermanentTokenAndDeviceIdFromActionPayload = exports.selectTokenFromActionPayload = exports.selectHasTokenRefreshed = exports.selectUser = exports.selectIsAuthenticated = exports.selectTokenExpiryTime = exports.selectDeviceId = exports.selectPermanentToken = exports.selectToken = exports.selectAuthenticationDomain = undefined;
...
var selectPermanentToken = (0, _reselect.createSelector)(selectAuthenticationDomain, function (authState) {
  return authState.get('permanentToken');
});

var selectDeviceId = (0, _reselect.createSelector)(selectAuthenticationDomain, function (authState) {
  return authState.get('deviceId');
});
...
var selectPermanentTokenAndDeviceIdFromActionPayload = function selectPermanentTokenAndDeviceIdFromActionPayload(action) {
  return {
    permanentToken: (0, _get3.default)(action, ['payload', 'data', 'permanentToken']),
    deviceId: (0, _get3.default)(action, ['payload', 'data', 'deviceId'])
  };
};

exports.selectAuthenticationDomain = selectAuthenticationDomain;
exports.selectToken = selectToken;
exports.selectPermanentToken = selectPermanentToken;
...
exports.selectPermanentTokenAndDeviceIdFromActionPayload = selectPermanentTokenAndDeviceIdFromActionPayload;