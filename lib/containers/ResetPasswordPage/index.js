...
var mapStateToProps = (0, _reselect.createStructuredSelector)({
  ResetPasswordPage: (0, _selectors2.default)()
});
...
var ResetPasswordPage = (_dec = (0, _compose2.default)(_hocs.AuthenticationContext), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), (0, _reactIntl.injectIntl)(_class = _dec(_class = _dec2(_class = function (_PureComponent) {
  ...
  _createClass(ResetPasswordPage, [{
    ...
    value: function renderGoNextBtn() {
      if (this.props.isAuthenticated) {
        return _react2.default.createElement(_reactRouter.Link, { to: '/home' });
      }

      return _react2.default.createElement(_reactRouter.Link, { to: '/sign-in' });
    }
  }, {
    ...
    value: function renderGoToRequestPasswordPageLink() {
      return _react2.default.createElement(_reactRouter.Link, { to: '/request-password-reset' });
    }
  }, {
    key: 'renderForm',
...
ResetPasswordPage.propTypes = {
  ...
  ResetPasswordPage: _react.PropTypes.object,
