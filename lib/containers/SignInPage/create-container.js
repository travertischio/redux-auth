...
function createSignInContainer(PageComponent) {
  ...
  var SignInContainer = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), AuthWrapper(_class = (0, _reactIntl.injectIntl)(_class = _dec(_class = (_temp = _class2 = function (_PureComponent) {
