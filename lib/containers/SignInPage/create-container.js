...
function createSignInContainer(PageComponent) {
  ...
  var SignInContainer = (_dec = (0, _UserIsNotAuthenticated2.default)(_config2.default.redirectPathAfterSignIn), _dec2 = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), _dec(_class = (0, _reactIntl.injectIntl)(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
