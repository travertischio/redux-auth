...
var _createUserIsNotAuthenticatedAuthWrapper = require('./createUserIsNotAuthenticatedAuthWrapper');

var _createUserIsNotAuthenticatedAuthWrapper2 = _interopRequireDefault(_createUserIsNotAuthenticatedAuthWrapper);
...
var UserIsNotAuthenticated = function UserIsNotAuthenticated(failureRedirectPathOrPageComponent) {
  ...
  if ((0, _isString3.default)(failureRedirectPathOrPageComponent)) {
    ...
    return (0, _createUserIsNotAuthenticatedAuthWrapper2.default)(_failureRedirectPath);
  }
  ...
  var authWrapper = (0, _createUserIsNotAuthenticatedAuthWrapper2.default)(failureRedirectPath);
